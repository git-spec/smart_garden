  ...
  if (myState.password !== myState.repassword || myState.password.trim() === '') {
    const errorElement = (
      <ul> 
        ...
        .password
        .trim() === ''
        ? <li>Password is empty <br></br> please make sure that you use a valid Password</li>
        : null}
        {myState.password !== myState.repassword ? <li>Password didn't match Repassword, <br></br> Please Be Sure That Password and Repassword is matching each other</li>: null}
      </ul>
    )
    setMyState({
      ...myState,
      ...
      switch (data) {
        ...
        case 4:
          ...
          break;
        case 1:
          setMyState({...myState, entriesError: true, errorElement: <p>We have reset your password, <br></br> tray to login from  <Link className="breadcrumb-item" to="/login"> here </Link>  </p>, errorTitle: 'Password is successfully changed' });
...
const closeModal = () => {
  ...
  return (
    <React.Fragment>
      ...
      <Container>
          <h1>My Account /Reset Password</h1> <br/>
          ...
          <InputGroup className="mb-3">
                ...
                <div className="col-md-4">
                  <Button className="btn black" onClick={onConfirmBtnClick}>Confirm</Button>
                </div>
          </InputGroup>
      </Container>
    </React.Fragment>
