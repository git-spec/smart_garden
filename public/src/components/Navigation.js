            ...
            <Container className="px-sm-3 px-0">
                ...
                <NavbarBrand href="/" className="flex-grow-1">
                    <svg
                        ...
                        height="181px"
                        viewBox="0 0 653 181"
                        enableBackground="new 0 0 653 181"
                    >
                        <defs></defs>
                        <path
                            fill="#9AC992"
                            d="M457.386,54.117c-8.221-7.868-19.855-11.857-34.58-11.857h-29.128c-3.313,0-6,2.687-6,6s2.687,6,6,6h29.128
                        ...
                        <path
                            fill="#9AC992"
                            d="M246.593,23.99c0-11.046-8.955-20-20-20c-11.047,0-20,8.954-20,20c0,8.955,5.886,16.533,14,19.082v5.142
                        ...
                        <path
                            fill="#9AC992"
                            d="M340.386,54.117c-8.219-7.866-19.85-11.855-34.57-11.857h-0.003l-39.207-0.047h-0.007
                        ...
                        <path
                            fill="#9AC992"
                            d="M653.074,48.252c0-3.313-2.687-6-6-6s-6,2.687-6,6v116.851l-33.2-0.04h-0.007
                        ...
                        <path
                            fill="#9AC992"
                            d="M540.867,165.063c-22.949,0-35.08-11.521-35.08-33.316V40.022h20.422c3.313,0,6-2.687,6-6s-2.687-6-6-6
                        ...
                        <path
                            fill="#9AC992"
                            d="M159.157,0H22.055C9.875,0,0,9.874,0,22.054v137.103c0,12.181,9.875,22.055,22.055,22.055h64.313V96.762
                        ...
                        <path
                            fill="#9AC992"
                            d="M22.041,65.492c0,3.564,16.227,8.73,23.107,8.73c4.966,0,11.266-4.11,11.266-8.73
                            c0-4.619-6.3-8.729-11.266-8.729C38.268,56.763,22.041,61.928,22.041,65.492z"
                        />
                        <path
                            fill="#9AC992"
                            d="M159.17,48.264c0-3.564-16.227-8.729-23.107-8.729c-4.966,0-11.266,4.11-11.266,8.729
                    ...
                    <Nav vertical className="mx-3">
                        ...
                        {props.user ? (
                            <Fragment>
                                ...
                                <NavItem>
                                    <NavLink href="#" onClick={logoutBtnClick}>
                                        logout
                                    </NavLink>
                                </NavItem>
                            </Fragment>
